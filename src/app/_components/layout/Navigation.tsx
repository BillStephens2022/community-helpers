    ...
    <nav className={styles.navbar_nav}>
      ...
      <li className={styles.nav_item}>
        ...
        {session ? (
          <>
            <li className={styles.nav_item}>
              <Link href="/profile" className={`${styles.nav_item} ${styles.nav_link} ${
            ...
            <li className={styles.nav_item}>
              <Link href="/community" className={`${styles.nav_item} ${styles.nav_link} ${
                  pathname === "/community" ? styles.active : ""
                }`} onClick={handleLinkClick}>
                Community
              </Link>
            </li>
            <li className={styles.nav_logout_button}>
              <button
                type="button"
